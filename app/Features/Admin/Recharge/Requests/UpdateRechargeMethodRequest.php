...
class UpdateRechargeMethodRequest extends FormRequest
{
    ...
    {
        $rechargeMethodId = $this->route('rechargeMethod')?->id;

        return [
            'code' => ['required', 'string', 'max:50', 'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/', Rule::unique('recharge_methods', 'code')->ignore($rechargeMethodId)],
