...
it('keeps the Blade and instant lookup result designs visually aligned', function (): void {
    ...
    expect($blade)
        ...
        ->toContain("'https://www.google.com/search?q='.rawurlencode(\$violationBehavior)")
        ...
        ->toContain('Nội dung vi phạm')
        ->toContain('Xem mức phạt')
        ->toContain("new URL('https://www.google.com/search')")
        ->toContain("penaltySearchUrl.searchParams.set('q', violationBehavior)")
        ->toContain("penaltyLink.target = '_blank'")
        ->toContain('border border-slate-300 bg-white')
        ->toContain('border border-red-200 bg-red-50')
