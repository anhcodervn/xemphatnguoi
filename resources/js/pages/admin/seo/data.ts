...
export const seoCategories: SeoCategoryItem[] = [
    {
        id: 1,
        name: "Hướng dẫn API proxy",
        slug: "huong-dan-api-proxy",
        seoTitle: "Hướng dẫn API mua proxy | DailyProxy",
        seoDescription: "Nhóm bài viết hướng dẫn tạo đơn proxy, cấu hình payload và xử lý kết quả trả về.",
        robots: "index,follow",
        articleCount: 14,
    ...
    },
    {
        ...
        seoTitle: "Vận hành queue và đơn proxy | DailyProxy",
        seoDescription: "Quản trị queue, đơn proxy, cảnh báo và theo dõi trạng thái dịch vụ.",
        robots: "index,follow",
        articleCount: 11,
    ...
    },
    {
        ...
        seoTitle: "Chính sách sử dụng dịch vụ | DailyProxy",
...
export const seoPosts: SeoPostItem[] = [
    {
        ...
        category: "Hướng dẫn API proxy",
        status: "published",
        seoScore: 92,
        canonicalUrl: "https://giapproxy.vn/blog/huong-dan-tao-task-proxy-dau-tien-tren-giapproxy",
        updatedAt: "2026-06-01 11:20",
    },
    {
        id: 2,
        title: "Checklist queue và retry an toàn cho đơn proxy",
        slug: "checklist-queue-va-retry-an-toan-cho-task-proxy",
        category: "Vận hành hệ thống",
        status: "published",
        seoScore: 88,
        canonicalUrl: "https://giapproxy.vn/blog/checklist-queue-va-retry-an-toan-cho-task-proxy",
    ...
    },
    {
        ...
        status: "draft",
        seoScore: 74,
        canonicalUrl: "https://giapproxy.vn/blog/khi-nao-nen-dung-noindex-cho-trang-noi-bo",
