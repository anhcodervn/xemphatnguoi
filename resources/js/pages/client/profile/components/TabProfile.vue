        ...
        <section class="space-y-3">
            <div class="rounded-[10px] border border-slate-200/80 bg-white p-4">
                ...
                <div class="mt-3 space-y-2">
                    <div v-for="meta in props.accountMeta" :key="meta.label" class="flex flex-col gap-1 rounded-[10px] bg-slate-50/80 px-3 py-2.5 sm:flex-row sm:items-start sm:justify-between sm:gap-3">
