...
export default {
    ...
    children: [
        ...
        { path: 'articles', name: 'admin.articles.index', component: () => import('@/pages/admin/seo/posts/index.vue') },
        { path: 'articles/create', name: 'admin.articles.create', component: () => import('@/pages/admin/seo/posts/create/index.vue') },
        { path: 'articles/:seo_post_id(\\d+)', name: 'admin.articles.show', component: () => import('@/pages/admin/seo/posts/create/index.vue') },
        { path: 'categories', name: 'admin.categories.index', component: () => import('@/pages/admin/seo/categories/index.vue') },
        { path: 'tags', name: 'admin.tags.index', component: () => import('@/pages/admin/seo/tags/index.vue') },
