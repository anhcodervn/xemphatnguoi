...
export const adminCouponService = {
    ...
    async logs(params: Record<string, unknown> = {}): Promise<CouponLogListResponse> {
        const response = await api.get('/admin-api/coupons/logs', { params });
