...
@section('badge', 'Tạo tài khoản trong vài bước')
    ...
    <script>
        (() => {
            ...
            const setLoadingState = (isLoading) => {
                ...
                submitButton.innerHTML = isLoading ? 'Đang tạo tài khoản...' : defaultButtonText;
            };

            const clearFieldErrors = () => {
                form.querySelectorAll('.register-field-error').forEach((element) => element.remove());
            ...
            const showFieldErrors = (errors = {}) => {
                Object.entries(errors).forEach(([field, messages]) => {
                    ...
                    errorElement.className = 'register-field-error text-sm text-red-600';
            ...
            form.addEventListener('submit', async (event) => {
                ...
                try {
                    ...
                    await Swal.fire({
                        ...
                        text: response.data?.message ?? 'Tài khoản của bạn đã được tạo.',
                    ...
                    const message = response?.data?.message ?? 'Đăng ký thất bại. Vui lòng kiểm tra lại thông tin.';
