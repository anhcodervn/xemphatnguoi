...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('proxy_products', function (Blueprint $table): void {
            $table->dropColumn(['duration_days', 'min_quantity']);
        });
    ...
    {
        Schema::table('proxy_products', function (Blueprint $table): void {
            $table->unsignedInteger('duration_days')->default(30)->after('selling_price');
            $table->unsignedInteger('min_quantity')->default(1)->after('duration_days');
        });

        Schema::create('proxy_product_durations', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('proxy_product_price_tiers', function (Blueprint $table): void {
            $table->id();
